...
export const PostPage = () => {
    ...
    const {id} = useParams();
    const [user, setUser] = useState({email: '', _id: ''});
    ...
    return (
        post && <div className="w-full">
            <main className="mx-auto w-8/12">
                ...
                <div className={'flex items-center text-sm text-gray-600'} onClick={() => navigate(`/profile/${post.author._id}`)}>
                    by <img
                    ...
                    alt="avatar"
                    className="w-8 h-8 rounded-full mr-2"/>{post.author.username} on {new Date(post.createdAt).toLocaleDateString()}
                </div>
                <div className="mb-4">
                ...
                <div className="mb-4">
                    ...
                    {comments.map(comment => (
                        <div key={comment._id} className="mb-2 px-4 py-2 border rounded bg-gray-100">
                            <p className="text-sm text-gray-600">{comment.content}</p>
                            <p className="flex items-center text-xs text-gray-500"
                               onClick={() => navigate(`/profile/${comment.author._id}`)}>By <img
                                src={`data:image/png;base64,`}
                                alt="avatar"
                                className="w-6 h-6 rounded-full mr-2"/>{comment.author.username} on {new Date(comment.createdAt).toLocaleDateString()}
                            </p>
                        </div>
                    ))}
                </div>
                <form onSubmit={handleCommentSubmit} className="mb-4">
                    <label className="block text-sm font-medium mb-2" htmlFor="comment">Leave a Comment</label>
                    <textarea
                        id="comment"
                        ...
                        required
                    />
                    <button type="submit" className="px-4 py-2 bg-primary text-primary-foreground rounded-lg">Submit
                    </button>
                </form>
            </main>
        </div>
